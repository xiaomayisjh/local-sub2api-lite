...
func ProvideConcurrencyCache(rdb *RedisStub, cfg *config.Config) service.ConcurrencyCache {
...
func ProvideSessionLimitCache(rdb *RedisStub, cfg *config.Config) service.SessionLimitCache {
...
func ProvideSchedulerCache(rdb *RedisStub, cfg *config.Config) service.SchedulerCache {
...
// 依赖：config.Config
// 提供：*RedisStub
func ProvideRedis(cfg *config.Config) *RedisStub {
