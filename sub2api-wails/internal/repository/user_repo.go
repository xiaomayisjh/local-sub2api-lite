...
import (
	...
	"sub2api-wails/ent/apikey"
	"sub2api-wails/ent/authidentity"
	"sub2api-wails/ent/authidentitychannel"
	dbgroup "sub2api-wails/ent/group"
	"sub2api-wails/ent/identityadoptiondecision"
	"sub2api-wails/ent/predicate"
	dbuser "sub2api-wails/ent/user"
	"sub2api-wails/ent/userallowedgroup"
	"sub2api-wails/ent/usersubscription"
...
func (r *userRepository) GetLatestUsedAtByUserIDs(ctx context.Context, userIDs []int64) (map[int64]*time.Time, error) {
	...
	rows, err := r.sql.QueryContext(ctx, query, pqcompat.Array(userIDs))
	if err != nil {
		return nil, err
	}
